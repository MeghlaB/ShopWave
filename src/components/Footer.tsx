...
const FOOTER_LINKS = {
  Shop: [
    ...
    { label: "Audio", href: "/items?category=Audio" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-3 mb-4 group">
              ...
              <img src="/powersync.svg" alt="" aria-hidden="true" className="h-10 w-auto" />
              <span className="michroma text-lg font-bold text-white tracking-widest group-hover:text-blue-400 transition-colors">
                SHOPWAVE
              </span>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed mb-6 max-w-xs">
              Your destination for premium electronics and gadgets. Quality products, unbeatable
          ...
          {Object.entries(FOOTER_LINKS).map(([heading, links]) => (
            <div key={heading}>
              <h3 className="michroma text-xs font-bold text-white uppercase tracking-widest mb-4">
                {heading}
              </h3>
